...
exec("$exiv2 -g Exif.Image.Model -g Exif.Image.Orientation -g Exif.Image.DateTime -g Exif.Photo.ExposureTime -g Exif.Photo.FNumber -g Exif.CanonCs.LensType -PEIkvt ".escapeshellarg($path), $lines, $return);
$result = array('file' => $file,
              ...
              'lens' => preg_replace('/Canon EF(-S)?/', '', str_replace('(65535)', '', exif_value($lines[5], 2))));
